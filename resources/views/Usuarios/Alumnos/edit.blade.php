            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 bg-primario rounded-top mb-3">
                    <div class="col-12 py-4">
                        <h1 class="text-white fw-bold text-center fs-4 mb-2">Editar Alumno - {{ $usuario->get_fullname }}
                        </h1>
                ...
                <!-- Form -->
                <form name="formulario_01" action="{{ route('alumnos.update', $usuario) }}" class="form" method="POST"
                    id="from-create">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-10 my-2">
                                ...
                                <div class="form-floating my-0">
                                    <input onclick="myFunction()" autocomplete="off" type="text"
                                        value="{{ old('matricula') ? old('matricula') : $usuario->matricula }}"
                                        name="matricula" placeholder="input-text" data-index="2" id="input-text"
                                        @class([
                                            'form-control' => !$errors->first('matricula'),
                                            'form-control is-invalid' => $errors->first('matricula'),
                                        ])>
                            ...
                            <div class="col-12 col-lg-10 my-2">
                                ...
                                <div class="form-floating my-0">
                                    <input autocomplete="off" type="text"
                                        value="{{ old('nombre') ? old('nombre') : $usuario->nombre }}" name="nombre"
                                        placeholder="input-text" data-index="2" id="nombre" @class([
                            ...
                            <div class="col-12 col-lg-10 my-2">
                                ...
                                <div class="form-floating my-0">
                                    <input type="text" name="apellido_paterno"
                                        ...
                                        placeholder="Apellido Materno" id="apellido_paterno" data-index="3"
                                        autocomplete="off" @class([
                                            'form-control' => !$errors->first('apellido_paterno'),
                                            'form-control is-invalid' => $errors->first('apellido_paterno'),
                                        ])>
                            ...
                            <div class="col-12 col-lg-10 my-2">
                                ...
                                <div class="form-floating my-0">
                                    <input onclick="myFunction()" type="text" name="apellido_materno"
                                        value="{{ old('apellido_materno') ? old('apellido_materno') : $usuario->apellido_materno }}"
                                        placeholder="Apellido Paterno" id="input-text" data-index="4" autocomplete="off"
                                        @class([
                                            'form-control' => !$errors->first('apellido_materno'),
                                            'form-control is-invalid' => $errors->first('apellido_materno'),
                                        ])>
                            ...
                            <div class="col-12 col-lg-10 my-2">
                                ...
                                <div class="form-floating my-0">
                                    <input onclick="myFunction()" type="text" name="email"
                                        value="{{ old('email') ? old('email') : $usuario->email }}"
                                        placeholder="Correo electronico" id="input-email" data-index="5" autocomplete="off"
                                        @class([
                                            'form-control' => !$errors->first('email'),
                                            'form-control is-invalid' => $errors->first('email'),
                                        ])>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex w-50 justify-content-between justify-content-lg-start">
                                                <div class="d-flex me-2">
                                                    <input onclick="myFunction()" class="form-check-input mx-auto"
                                                        name="sexo" type="radio" value="F"
                            ...
                            <div class="col-12 col-lg-10 my-2">
                                ...
                                <div class="form-floating my-0">
                                    <input id="password" type="password" name="password" placeholder="Contraseña"
                                        data-index="6" {{-- value="{{ (old( 'password' )) ? old( 'password' ) : $administradorPlataforma->password}}" --}} autocomplete="off"
                                        @class([
                                    ...
                                    <div class="row items-center justify-content-start">
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex w-50 justify-content-between justify-content-lg-start">
                                                <div class="d-flex me-2">
                                                    <input onclick="myFunction()" class="form-check-input mx-auto"
                                                        name="activo" type="radio" id="opcion-2" value="0"
                                                ...
                                                <div class="d-flex me-2">
                                                    <input onclick="myFunction()" class="form-check-input mx-auto"
                                                        name="activo" type="radio" id="opcion-1" value="1"
                                                        @if ($usuario->activo) checked @endif>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-3">
                    <button onclick="myFunction()" type="submit"
                        class="btn btn-md d-block w-100 text-white btn-primario">Guardar Cambios</button>
                </div>
            </div>
            <div class="d-flex justify-content-end mt-5">
                <a title="Regresar" href="{{ route('alumnos.index') }}" class="text-end fs-6 text-secundario"><img
