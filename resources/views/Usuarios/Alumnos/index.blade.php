...
<div class="container-fluid p-0">
    ...
    <div class="col-12 bg-primario rounded-top mb-3">
        <div class="col-12 py-4">
            <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Alumnos</h1>
    ...
    <div class="row w-100 h-100 m-0 p-0">
        ...
        <!-- Header Section -->
        <form action="{{ route('alumnos.index') }}" method="POST" class="row w-100 p-0 mx-auto align-items-center" id="form-number-items">
            ...
            <div class="col-12">
                            ...
                            <td>
                                <div class="row justify-content-center w-100">
                                    ...
                                    <div class="col text-center px-0">
                                        <a href="{{ route('alumnos.edit', $usuario) }}" class="btn btn-sm btn-primario text-white w-20">
                ...
                <div class="col-12">
                    <div class="col-12 col-md-4 my-2">
                        <a href="{{ route('download-pdf-alumnos') }}" class="btn btn-primario text-white btn-sm d-block mx-auto w-75">Descargar PDF</a>
                    </div>
                    <div class="col-12 col-md-4 my-2">
                        <a href="{{ route('download-excel-alumnos') }}" class="btn btn-primario text-white btn-sm d-block mx-auto w-75">Descargar Excel</a>
                    </div>
                </div>
