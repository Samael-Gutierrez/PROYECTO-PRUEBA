        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 bg-primario rounded-top mb-3">
                <div class="col-12 py-4">
                    <h1 class="text-white fw-bold text-center fs-4 mb-2">Editar Cuatrimestre - {{ $cuatrimestre->nombre }}</h1>
            ...
            <!-- Form -->
            <form action="{{ route('cuatrimestres.update', $cuatrimestre) }}" class="form" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-floating my-2">
                                ...
                                autocomplete="off" type="text" value="{{ (old( 'nombre' )) ? old( 'nombre' ) : $cuatrimestre->nombre}}" name="nombre" placeholder="input-text" id="input-text">
                                <label for="input-text">Nombre del Cuatrimestre</label>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex w-50 justify-content-between justify-content-lg-start">
                                                <div class="d-flex me-2">
                                                    <input class="form-check-input mx-auto" name="activo" type="radio" id="opcion-2" value="0" @if(!$cuatrimestre->activo) checked @endif>
                                                    <label class="form-check-label ms-1" for="opcion-1"> Inactivo </label>
                                                </div>

                                                <div class="d-flex me-2">
                                                    <input class="form-check-input mx-auto" name="activo" type="radio" id="opcion-1" value="1" @if($cuatrimestre->activo) checked @endif>
                ...
                <div class="d-flex justify-content-end mt-5">
                    <a title="Regresar" href="{{ route('cuatrimestres.index') }}" class="text-end fs-6 text-secundario"><img src="{{ asset('img/regresa.jpg')}}" width="30" height="30"></a>
                </div>
            </form>
            <!-- Form End -->
        </div>
