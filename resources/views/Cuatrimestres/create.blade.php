        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 bg-primario rounded-top mb-3">
                <div class="col-12 py-4">
                    <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Crear Nuevo Cuatrimestre</h1>
            ...
            <!-- Form -->
            <form action="{{ route('cuatrimestres.store') }}" class="form" method="POST">
                @csrf
                @method('POST')
