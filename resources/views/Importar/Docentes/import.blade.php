...
<div class="container-fluid p-0">
    ...
    <div class="col-12 bg-primario rounded-top mb-3">
        <div class="col-12 py-4">
            <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Alta Docentes</h1>
    ...
    <div class="container-fluid">
        ...
        <div class="row w-100 h-100 m-0 p-0 my-0">
              <form action="{{ route('docentesimport.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <h6>Ingresa Archivo:</h6>
                    <div class="col-12 col-md-12 text-center my-2 d-flex">
                    ...
                    <div class="col-8 col-md-3 text-center p-0 d-flex">
                        <a href="{{ route('exportarejemplodocentes') }}" class="btn btn-success my-0 mx-auto w-30">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-filetype-exe" viewBox="0 0 16 16">
    ...
    <div class="col-12 bg-quintuario rounded-top mb-6 p-0">
        <div class="col-12 py-3">
            ...
            <p class="text-primario">
                ...
                &nbsp &nbsp 2.- La información a ingresar en el archivo, debe ser texto o información sin formato alguno. <br>
                &nbsp &nbsp 3.- El campo género debe contener un solo caracter "F" o "M". "F" para Femenino o "M" para Masculino.<br>
                &nbsp &nbsp 4.- En caso de crear su propio archivo de importación, usted  debe tener el formato ".xlsx" y debe de tener
        ...
        <div class="d-flex justify-content-end mt-0">
            <a title="Regresar" href="{{ route('docentes.index') }}" class="text-end fs-0 text-secundario"><img src="{{ asset('img/regresa.jpg')}}" width="30" height="30"></a>
        </div>
