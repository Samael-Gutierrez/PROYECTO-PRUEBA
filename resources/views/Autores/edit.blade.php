...
<div class="container-fluid p-0">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <!-- Form -->
            <form action="{{ route('autores.update',$autor) }}" class="form" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="form-check my-2">
                                <div class="row items-center justify-content-center">
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="activo" type="radio" id="opcion-1" value="1" required @if($autor->activo) checked @endif>
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="activo" type="radio" id="opcion-2" value="0" required @if(!$autor->activo) checked @endif>
