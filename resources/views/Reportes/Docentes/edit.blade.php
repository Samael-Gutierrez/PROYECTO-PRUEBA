...
<div class="container-fluid p-0">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <!-- Container Slogan -->
             ...
             <form name="formulario_01"
               action="{{ route('reportedocentes.update', $usuario) }}"  class="form" method="POST" id="from-create">
                 @csrf
                 @method('PUT')
        ...
        <div class="d-flex justify-content-end mt-5">
            <a title="Regresar" href="{{ route('reportedocentes.index') }}" class="text-end fs-6 text-secundario"><img src="{{ asset('img/regresa.jpg')}}" width="30" height="30"></a>
        </div>
        </form>
        <!-- Form End -->
    </div>
