...
<div class="collapse collapse-catalogos" id="catalogos">
    <div class="">
        ...
        <a href="{{ route('areas.index') }}" class="sidebar-link py-2">
            <div class="col-11">
        ...
        <a href="{{ route('carreras.index') }}" class="sidebar-link py-2">
            <div class="col-11">
                <div class="row w-100 align-items-center mx-auto justify-content-center">
                    <div class="col-4 p-0 text-end">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-mortarboard" viewBox="0 0 16 16">
        ...
        <a href="{{ route('ciclos.index') }}" class="sidebar-link py-2">
            <div class="col-12">
                <div class="row w-100 align-items-center mx-auto justify-content-center">
                    <div class="col-4 p-0 text-end">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-calendar-month" viewBox="0 0 16 16">
        ...
        <a href="{{ route('cuatrimestres.index') }}" class="sidebar-link py-2">
            <div class="col-11">
                <div class="row w-100 align-items-center mx-auto justify-content-center">
                    <div class="col-4 p-0 text-end">
        ...
        <a href="{{ route('docentes.index') }}" class="sidebar-link py-2">
            <div class="col-11">
                <div class="row w-100 align-items-center mx-auto justify-content-center">
                    <div class="col-4 p-0 text-end">
        ...
        <a href="{{ route('tipodeusuarios.index') }}" class="sidebar-link py-2">
            <div class="col-11">
                <div class="row w-100 align-items-center mx-auto justify-content-center">
                    <div class="col-4 p-0 text-end">
