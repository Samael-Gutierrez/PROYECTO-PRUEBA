...
class AuthBibliotecaController extends Controller
{
    public function login()
    {
        return view('Auth.Biblioteca.login');
    }
    ...
    public function authenticate(AuthRootRequest $request){
        ...
        if (Auth::guard('root')->attempt($credentials)) {
            ...
            return redirect()->route('loginbiblioteca')->with('message', 'Credenciales de Acceso Incorrectas');
        }
    }
